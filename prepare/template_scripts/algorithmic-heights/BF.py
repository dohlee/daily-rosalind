...
# 
# Given: A simple directed graph with integer edge
#  weights from -10^(3) to 10^3 and n <= 10^3 vertices
...
if __name__ == '__main__':
    # Load the data.
    with open('../../datasets/rosalind_BF.txt') as inFile:
        pass

    # Print output
    with open('../../answers/rosalind_BF_out.txt', 'w') as outFile:
        pass
