...
# 
# Given: A simple directed graph with positive edge
#  weights from 1 to 10^3 and n <= 10^3 vertices
...
if __name__ == '__main__':
    # Load the data.
    with open('../../datasets/rosalind_DIJ.txt') as inFile:
        pass

    # Print output
    with open('../../answers/rosalind_DIJ_out.txt', 'w') as outFile:
        pass
